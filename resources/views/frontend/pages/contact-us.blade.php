    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                            <div class="d-flex align-items-center bg-light rounded p-4">
                                ...
                                <span>{{ $generalSetting->location }}</span>
                            </div>
                        </div>
                ...
                <div class="col-md-6 wow fadeInUp  m-auto" data-wow-delay="0.1s">
                    <center>
                        <a href="/" class="navbar-brand d-flex justify-content-center py-0 px-4 px-lg-5">
