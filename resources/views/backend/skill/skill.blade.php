        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="#" class="btn btn-dark btn-sm modal-btn btn-sm" role="button" aria-disabled="true"
                   data-toggle="modal" data-target="#exampleModal">Add Skill</a>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(['url' => '/admin/skill','method'=>'post']) !!}
                        ...
                        @foreach($data as $key => $value)
                            <tr>
                                ...
                                <td class="justify-content-center">
                                    {{ Form::open(['url' => "/admin/skill/$value->id", 'method'=>'DELETE'])  }}
                                    <button class="btn btn-default text-danger btn-sm">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    {{ Form::close()  }}
                                    {{ Form::open(['url' => "/admin/skill/$value->id/edit", 'method'=>'GET'])  }}
